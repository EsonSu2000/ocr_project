...
export const ocrengine_findKeywordPosition: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const textword_json: (a: number) => [number, number];
